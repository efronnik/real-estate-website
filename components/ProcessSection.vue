...
.service-row::before {
  ...
  inset: 0;
  background-image:
    linear-gradient(160deg, rgba(0, 0, 0, 0.58), rgba(0, 0, 0, 0.58)),
    var(--bg);
...
.service-word > span:first-child {
  display: inline-block;
  position: relative;
}

.service-word > span:first-child::after {
  content: "";
  position: absolute;
  left: 0;
  right: 0;
...
.service-row:hover .service-word > span:first-child::after {
  transform: scaleX(1);
}
